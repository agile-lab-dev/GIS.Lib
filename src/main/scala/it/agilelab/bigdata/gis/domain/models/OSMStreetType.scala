...
object OSMStreetType {
  ...
  val values = Seq(MOTORWAY, SECONDARY, TRUNK, UNCLASSIFIED, TERTIARY, PRIMARY_LINK, SECONDARY_LINK,
    TERTIARY_LINK, LIVING_STREET, BUS_GUIDEWAY, ESCAPE, RACEWAY, ROAD, PROPOSED, CONSTRUCTION,
    BRIDLEWAY, PRIMARY, TRACK, RESIDENTIAL, PEDESTRIAN, TRUNK_LINK, MOTORWAY_LINK, FOOTWAY,
    SERVICE, PATH, CYCLEWAY, TRACK_GRADE2, STEPS, ND)
