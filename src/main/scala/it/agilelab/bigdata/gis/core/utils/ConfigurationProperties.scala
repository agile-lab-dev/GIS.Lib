...
object ConfigurationProperties {
  ...
  case object ADDRESS_TOL_METERS extends ConfigurationProperties { override lazy val value: String = "address_tol_meters" }
  case object GRAPH_LOCATION extends ConfigurationProperties { override lazy val value: String = "graph_location" }
  case object ELEVATION_ENABLED extends ConfigurationProperties { override lazy val value: String = "elevation_enabled" }
  case object MAP_MATCHING_ALGORITHM extends ConfigurationProperties { override lazy val value: String = "map_matching_algorithm" }
  case object MEASUREMENT_ERROR_SIGMA extends ConfigurationProperties { override lazy val value: String = "measurement_error_sigma" }
  case object CONTRACTION_HIERARCHIES_ENABLED extends ConfigurationProperties { override lazy val value: String = "contraction_hierarchies_enabled" }
